...
<head>
	...
	<script type="text/javascript">
		...
		function optDelete(id) {
			...
			window.location = "<%=basePath%>log/o_delete_operating?id="+id;
		}
		//批量删除数据
		function optDeleteIn() {
			...
			//console.log(ids);
			window.location = "<%=basePath%>log/o_delete_operating_in.do?ids="+ids;
		}
	</script>
</head>
<body>
			...
			<div class="bd">
				<table class="ui-table">
					...
					<tfoot>
						<tr>
							<td colspan="7">
								<a class="btn" href="javascript:;" onclick="optDeleteIn();">批量删除</a>
							</td>
						</tr>
					</tfoot>
				</table>
