...
<head>
	...
	<script type="text/javascript">
		...
		function optDelete(id) {
			...
			window.location = "<%=basePath%>log/o_delete_login_failure.do?id="+id;
		}
		//批量删除数据
		function optDeleteIn(type) {
			...
			//console.log(ids);
			window.location = "<%=basePath%>log/o_delete_login_failure_in.do?ids="+ids;
		}
	</script>
</head>
<body>
	<div class="container">
		<div class="toolbar">
			<div class="crumbs">
				<a href="#">用户管理</a> -&gt; <span>登录失败日志</span>
			</div>
		</div>
		<div class="mod">
			<div class="hd">
				<form class="search-form" method="post" action="log/find_log_failure.do">
					<label for="ip">IP: </label>
					<input class="ipt" type="text" name="ip" id="ip" value="${ip}"/>
			...
			<div class="bd">
				<table class="ui-table">
					...
					<tfoot>
						<tr>
							<td colspan="6">
								<a class="btn" href="javascript:;" onclick="optDeleteIn('2');">批量删除</a>
							</td>
						</tr>
					</tfoot>
				</table>
			...
			<div class="mod-ft">
		    	<pg:pager items="${logPager.total}" maxPageItems="10" maxIndexPages="10" url="log/find_log_failure.do" export="currentPageNo = pageNumber">
